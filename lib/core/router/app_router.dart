...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    initialLocation: '/parent-account', // 👈 changed
    redirect: (context, state) {
      ...
      if (!isLoggedIn && !isOnAuth &&
          state.uri.path != '/parent-account') return '/login'; // ✅ already bypasses /parent-account
      if (isLoggedIn && isOnAuth) {
        final role =
    ...
    routes: [
      ...
      GoRoute(path: '/parent-account', builder: (c, s) => const ParentSettingsScreen()),
